...
(function () {
  ...
  /**
   * 這一天負責採買的人。若那天輪到的人已經退伍，回傳 null 並附上提醒。
   * @returns {{memberId: string|null, warning: string|null}}
   */
  function shopperFor(dateStr, members, roster) {
    ...
    if (!window.App.State.isActiveOn(member, dateStr)) {
      return {
        memberId: null,
        warning: `${WEEKDAY_LABELS[weekday]}的採買人員 ${member.name} 已經退伍，這天沒有人採買，請到「採買」分頁改指定其他人。`,
      };
    }
